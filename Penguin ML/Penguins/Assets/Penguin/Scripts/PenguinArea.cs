...
public class PenguinArea : MonoBehaviour
{
    ...
    private void PlaceBaby()
    {
        ...
        penguinBaby.transform.rotation = Quaternion.Euler(0f, 180, 0f);
    }
    ...
    private void SpawnFish(int count, float fishSpeed)
    {
        for (int i = 0; i < count; i++)
        {
            ...
            //set the fish's parent to this area's transformation
            ...
            //Set the fish speed
            fishObject.GetComponent<FishRemaining>().fishSpeed = fishSpeed;
        }
    }
